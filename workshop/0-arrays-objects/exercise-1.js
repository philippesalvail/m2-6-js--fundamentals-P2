...
function menuList(list) {
  list.unshift("bean burritos");
  list.splice(list.length - 1, 1, "buffalo-flavored cauliflower");
  list.forEach((element) => {
    console.log("#" + (list.indexOf(element) + 1) + " is " + element);
  });
}

menuList(mostPopularFood);
